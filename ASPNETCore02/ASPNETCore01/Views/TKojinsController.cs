...
namespace ASPNETCore02.Views
{
    public class TKojinsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ENamae,ENenrei,ESeibetsu")] TKojin tKojin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ENamae,ENenrei,ESeibetsu")] TKojin tKojin)
        {
            if (id != tKojin.Id)
            {
                return NotFound();
